...
.nk-register-box-logo{display:flex;align-items:center;justify-content:center;gap:8px;color:#fff;font-size:20px;font-weight:800;margin-bottom:24px;}
.nk-register-box-logo img{height:64px;filter:brightness(0) invert(1);}
