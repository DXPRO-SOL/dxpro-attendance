...
.nk-register-box{background:linear-gradient(135deg,#2864F0,#4080FF);padding:32px;border-radius:16px;text-align:center;box-shadow:0 8px 32px rgba(40,100,240,.2);}
.nk-register-box-title{color:#fff;font-size:18px;font-weight:700;margin-bottom:4px;}
.nk-register-box-logo{display:flex;align-items:center;justify-content:center;gap:8px;color:#fff;font-size:20px;font-weight:800;margin-bottom:16px;}
.nk-register-box-logo img{height:24px;filter:brightness(0) invert(1);}
.nk-register-box-btn{display:flex;align-items:center;justify-content:center;gap:8px;background:#fff;color:#2864F0;padding:14px 28px;border-radius:8px;font-size:16px;font-weight:700;transition:all .3s;}
.nk-register-box-btn:hover{transform:scale(1.02);box-shadow:0 4px 16px rgba(255,255,255,.3);}
