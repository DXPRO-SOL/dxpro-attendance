...
<header class="nk-header">
  <div class="nk-header-inner">
    ...
    <div class="nk-header-buttons">
      ${
        member
          ? `
        <a href="/dashboard" class="nk-header-login">NOKORIへ</a>
        <a href="/nokori/logout" class="nk-header-register" style="background:#64748b;">ログアウト</a>
      `
          : `
  ...
  <nav class="nk-nav-mobile">
    ...
    ${
      member
        ? `
      <a href="/dashboard" style="border-top:2px solid #2864F0;margin-top:8px;padding-top:16px;">NOKORIへ</a>
      <a href="/nokori/logout">ログアウト</a>
    `
        : ""
    }
  </nav>
