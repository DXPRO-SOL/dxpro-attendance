...
<div class="sidebar">
    ...
    <div class="sb-submenu" id="edu-submenu">
        ...
        ${isAdmin ? `<a href="/admin/pretests"><i class="fa-solid fa-file-lines"></i> <span data-i18n="nav.edu_admin">テスト一覧（管理者）</span></a>` : ''}
    </div>
...
<div class="topbar">
    ...
    <div class="topbar-right">
        ...
        ${isAdmin ? '<span class="topbar-badge"><i class="fa-solid fa-shield-halved"></i> 管理者</span>' : ''}
