...
function buildSidebarHtml({
  ...
  return `
    ...
    <a href="/hr" class="sb-link ${active("/hr") && !currentPath.startsWith("/hr/payroll") && !currentPath.startsWith("/hr/daily") ? "sb-active" : ""}">
        <span class="sb-icon"><i class="fa-solid fa-users"></i></span><span data-i18n="nav.hr">人事管理</span>
    </a>`
        : ""
    }
    <a href="/hr/payroll" class="sb-link ${active("/hr/payroll")}">
        <span class="sb-icon"><i class="fa-solid fa-yen-sign"></i></span><span data-i18n="nav.payroll">給与明細</span>
    </a>
    <a href="/leave/apply" class="sb-link ${active("/leave/apply")}">
        <span class="sb-icon"><i class="fa-solid fa-plane-departure"></i></span><span data-i18n="nav.leave_apply">休暇申請</span>
    </a>
    <a href="/leave/my-requests" class="sb-link ${active("/leave/my-requests")}">
        <span class="sb-icon"><i class="fa-solid fa-calendar-check"></i></span><span data-i18n="nav.leave_history">休暇履歴</span>
    </a>
    <a href="/overtime" class="sb-link ${active("/overtime")}">
        <span class="sb-icon"><i class="fa-solid fa-clock"></i></span><span data-i18n="nav.overtime">残業申請</span>
    </a>
    <a href="/workflow" class="sb-link ${active("/workflow")}">
        <span class="sb-icon"><i class="fa-solid fa-diagram-project"></i></span><span data-i18n="nav.workflow">ワークフロー</span>
    </a>
    `
    }
    ...
    ${
      atLeastEmp
        ? `
    <a href="/knowledge" class="sb-link ${active("/knowledge") || active("/links")}">
        <span class="sb-icon"><i class="fa-solid fa-book-open"></i></span><span data-i18n="nav.knowledge">ナレッジ管理</span>
    </a>`
        : ""
    }
