 ...
 */
function buildSidebarHtml({ employee, isAdmin, role, currentPath, chatStatus }) {
  const r = role || (isAdmin ? "admin" : "employee");
  const st = chatStatus || 'online';
  const STATUS_CLS   = { online: 'sb-pip-online', break: 'sb-pip-break', offline: 'sb-pip-offline' };
...
<div class="topbar">
    <div class="topbar-title">
        <button class="mobile-menu-btn" id="mobileMenuBtn" onclick="toggleMobileSidebar()" aria-label="メニュー">
