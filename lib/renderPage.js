...
function buildSidebarHtml({
  ...
  return `
    ...
    <div class="sb-user">
        ...
        <div>
            ...
            <div class="sb-status-row" id="sb-status-row">
                ...
                <span class="sb-status-label" id="sb-status-label">${STATUS_LABEL[st]}</span>
            </div>
        </div>
    </div>
    ...
    <a href="/tasks" class="sb-link ${active("/tasks")}">
        <span class="sb-icon"><i class="fa-solid fa-list-check"></i></span>タスク管理
    </a>
    <a href="/chat" class="sb-link ${active("/chat")}">
        <span class="sb-icon"><i class="fa-solid fa-comments"></i></span>チャット
    </a>
    <a href="/schedule" class="sb-link ${active("/schedule")}">
        <span class="sb-icon"><i class="fa-solid fa-calendar-days"></i></span>スケジュール
    </a>
    ...
    <a href="/cloud" class="sb-link ${active("/cloud")}">
        <span class="sb-icon"><i class="fa-solid fa-cloud"></i></span>クラウドドライブ
    </a>
...
const NAV_LABELS = {
  "/dashboard": "ホーム",
  "/hr/daily-report": "日報管理",
  "/goals": "目標管理",
  "/tasks": "タスク管理",
  "/skillsheet": "スキルシート",
  "/hr/payroll": "給与明細",
  "/leave/apply": "休暇申請",
  "/leave/my-requests": "休暇履歴",
  "/overtime": "残業申請",
  "/board": "社内掲示板",
  "/cloud": "クラウドドライブ",
  "/rules": "会社規定",
  ...
  "/links": "リンク集",
  "/pretest": "テスト実施",
  "/pretest/answers": "模範解答",
  "/admin": "管理者メニュー",
  "/hr/payroll/admin": "給与管理",
  "/admin/leave-requests": "休暇承認",
  "/admin/overtime": "残業申請管理",
  "/admin/leave-balance": "有給付与",
  "/hr/add": "社員追加",
  "/admin/users": "ユーザー権限管理",
  "/admin/integrations": "外部API連携設定",
...
function getNavLabel(path, fallback) {
  return NAV_LABELS[path] || fallback;
}
...
${buildSidebarHtml({ employee, isAdmin, role, currentPath, chatStatus })}
</div>
...
<div class="topbar">
    ...
    <div class="topbar-title">
        ...
        ${getNavLabel(currentPath, title)}
    </div>
    <div class="topbar-right">
        <span class="topbar-date" id="topbar-clock"></span>
        <span class="topbar-role-badge">${buildRoleBadge(role, isAdmin)}</span>
