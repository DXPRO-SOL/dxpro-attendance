  ...
  var DICT = {
    ja: {
      nav: {
        ...
        contracts: "契約管理",
        admin_section: "管理者",
        admin_monthly_attendance: "月別勤怠照会",
        admin_approval_requests: "承認リクエスト一覧",
        admin_departments: "部署管理",
        admin_org_roles: "ロール・人事異動",
        admin_payroll_master: "給与マスター管理",
        admin_contract_types: "契約タイプ管理",
        admin_locations: "GPS場所管理",
        admin_skillmap: "スキルマップ",
        admin_daily_summary: "日報AI要約",
        admin_semi_assessments: "AI評価レポート",
        admin_audit_log: "監査ログ",
        admin_chat_management: "チャット管理",
        admin_ui_analytics: "UIアナリティクス",
      },
      topbar: {
        admin_badge: "管理者",
        notifications: "通知",
    ...
    en: {
      nav: {
        ...
        admin_section: "Admin",
        admin_monthly_attendance: "Monthly Attendance",
        admin_approval_requests: "Approval Requests",
        admin_departments: "Department Management",
        admin_org_roles: "Roles & Transfers",
        admin_payroll_master: "Payroll Master",
        admin_contract_types: "Contract Types",
        admin_locations: "GPS Location Management",
        admin_skillmap: "Skill Map",
        admin_daily_summary: "Daily Report AI Summary",
        admin_semi_assessments: "AI Assessment Report",
        admin_audit_log: "Audit Log",
        admin_chat_management: "Chat Management",
        admin_ui_analytics: "UI Analytics",
      },
      topbar: {
        admin_badge: "Admin",
    ...
    vi: {
      nav: {
        ...
        admin_monthly_attendance: "Chấm công tháng",
        admin_approval_requests: "Danh sách phê duyệt",
        admin_departments: "Quản lý phòng ban",
        admin_org_roles: "Vai trò & Điều chuyển",
        admin_payroll_master: "Quản lý lương master",
        admin_contract_types: "Loại hợp đồng",
        admin_locations: "Quản lý địa điểm GPS",
        admin_skillmap: "Bản đồ kỹ năng",
        admin_daily_summary: "Tóm tắt AI nhật ký",
        admin_semi_assessments: "Báo cáo đánh giá AI",
        admin_audit_log: "Nhật ký kiểm tra",
        admin_chat_management: "Quản lý chat",
        admin_ui_analytics: "Phân tích UI",
      },
      topbar: {
    ...
    ko: {
      nav: {
        ...
        contracts: "계약 관리",
        admin_section: "관리자",
        admin_monthly_attendance: "월별 근태 조회",
        admin_approval_requests: "승인 요청 목록",
        admin_departments: "부서 관리",
        admin_org_roles: "역할 및 인사 이동",
        admin_payroll_master: "급여 마스터 관리",
        admin_contract_types: "계약 유형 관리",
        admin_locations: "GPS 장소 관리",
        admin_skillmap: "스킬 맵",
        admin_daily_summary: "일보 AI 요약",
        admin_semi_assessments: "AI 평가 리포트",
        admin_audit_log: "감사 로그",
        admin_chat_management: "채팅 관리",
        admin_ui_analytics: "UI 분석",
      },
      topbar: {
        admin_badge: "관리자",
        notifications: "알림",
    ...
    zh: {
      nav: {
        ...
        contracts: "合同管理",
        admin_section: "管理员",
        admin_monthly_attendance: "月度考勤查询",
        admin_approval_requests: "审批请求列表",
        admin_departments: "部门管理",
        admin_org_roles: "角色与人事调动",
        admin_payroll_master: "薪资主数据管理",
        admin_contract_types: "合同类型管理",
        admin_locations: "GPS地点管理",
        admin_skillmap: "技能图谱",
        admin_daily_summary: "日报AI摘要",
        admin_semi_assessments: "AI评估报告",
        admin_audit_log: "审计日志",
        admin_chat_management: "聊天管理",
        admin_ui_analytics: "UI分析",
      },
      topbar: {
        admin_badge: "管理员",
        notifications: "通知",
